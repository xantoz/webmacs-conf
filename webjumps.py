...
define_webjump("gamefaqs", "https://www.gamefaqs.com/search?game=%s")
...
define_webjump("ratpoisonwiki", "https://ratpoison.wxcvbn.org/cgi-bin/wiki.pl?search=%s")
define_webjump("stumpwmwiki", "https://github.com/sabetts/stumpwm/search?q=%s")
define_webjump("cerise", "https://wiki.ceri.se/index.php?title=Special:Search&search=%s")
define_webjump("wa",     "https://www36.wolframalpha.com/input/?i=%s")
define_webjump("nyaa", "https://nyaa.si/?q=%s&f=0&c=0_0")
define_webjump("bakabt", "https://bakabt.me/browse.php?q=%s")
define_webjump("baka-updates", "https://www.baka-updates.com/search/search?searchitem=%s&submit.x=5&submit.y=15&submit=submit&searchradio=releases")
define_webjump("surugaya", "https://www.suruga-ya.jp/search?category=&search_word=%s")
...
define_webjump("youtube-user", "https://youtube.com/profile_videos?user=%s")
define_webjump("imdb", "https://imdb.com/find?q=%s")
...
define_webjump("ebay", "https://www.ebay.com/sch/i.html?_nkw=%s&_sacat=0")
define_webjump("ebayuk", "https://www.ebay.co.uk/sch/i.html?_from=R40&_sacat=0&_nkw=%s&_sop=15")
define_webjump("tradera", "https://www.tradera.com/search?sortBy=AddedOn&q=%s")
